    ...
    return (
        <header className="main-header p-2 sm:p-8 bg-gray-50">
            ...
            <nav className="thin-navbar">
                <ul>
                    <li><a href="https://sarahwooller.github.io/CRUK_datahub_landing_page/about.html">About</a></li>
                    <li>
            ...
            <p className="intro-text">
                    ...
                    Use the study filters on the left to explore our ground breaking work
                    and gain access to relevant data in a way which puts patient needs front and centre.
            </p>
        </header>
    );
};
