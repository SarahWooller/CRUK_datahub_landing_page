...
function transitionToNewChoices(newKey) {
  ...
  // This single change triggers the transition
  setTimeout(() => {
    newChoicesEl.classList.remove('slide-in');
  }, 10);
